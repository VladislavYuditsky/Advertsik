...
Сайт "Advertsik" предназначен для просмотра доски объявлений и предоставляет возможность подачи собственных.
...
* отсутствие доступа к сереверу из-за его отключения в связи с техническими работами;
...
* редактирование личных объявлений;
* удаление личных объявлений;
* поиск объявлений;
* выход из аккаунта.
